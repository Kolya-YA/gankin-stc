...
class Banner extends ActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'left_course' => 'Left column on find course page',
			'right_course' => 'Right column on find course page',
			'left_equipment' => 'Left column on find equipment page',
			'right_equipment' => 'Right column on find equipment page',
